...
-- 正在导出表  qingyi.v9_school 的数据：20 rows
...
REPLACE INTO `v9_school` (`id`, `type`, `school_name`, `provice`, `city`, `county`, `address`, `head`, `mobile`, `tel`, `medium_range`, `class_fee`, `qr_code`, `school_logo`, `micro_site_url`, `status`, `apply_type`, `create_time`) VALUES
	(2, 0, '测试学校', 2, 41, 0, '', '孙正', '110', '110', '', 0, '', '', '', 1, 0, 0),
	(3, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0, 0, 0),
	(4, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0, 0, 0),
	(5, 0, '测试学校', 6, 133, 0, '', '', '', '', '', 0, '', '', '', 1, 0, 0),
	(6, 0, '测试学校', 6, 134, 0, '', '', '', '', '', 0, '', '', '', 1, 0, 0),
	...
	(19, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0, 0, 0),
	(20, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0, 0, 0),
	(21, 0, '测试学校', 3, 98, 0, '测试学校地址', '', '110', '110', '测试范围', 0, '', '', '', 1, 0, 0),
