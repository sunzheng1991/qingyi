...
CREATE TABLE IF NOT EXISTS `v9_school` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='学校表';

-- 正在导出表  qingyi.v9_school 的数据：20 rows
/*!40000 ALTER TABLE `v9_school` DISABLE KEYS */;
REPLACE INTO `v9_school` (`id`, `type`, `school_name`, `provice`, `city`, `county`, `address`, `head`, `mobile`, `tel`, `medium_range`, `class_fee`, `qr_code`, `school_logo`, `micro_site_url`, `create_time`) VALUES
	(2, 0, '测试学校', 2, 0, 0, '', '孙正', '110', '110', '', 0, '', '', '', 0),
	(3, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0),
	(4, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0),
	(5, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0),
	(6, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0),
	...
	(19, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0),
	(20, 0, '测试学校', 2, 0, 0, '', '', '', '', '', 0, '', '', '', 0),
	(21, 0, '测试学校', 5, 98, 0, '测试学校地址', '', '110', '110', '测试范围', 0, '', '', '', 0);
