<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><?php include template("school","header"); ?>
	<div class="xxl_content">
		...
		<div class="xxl_content_1">
    			<div class="xxl_content_title">黄页信息发布申请</div>
...
<script type="text/javascript">
	$('.dosubmit').on("click",function(){
		...
		$.post('index.php?m=school&c=index&a=add_school',{dosubmit:'1',school_name:school_name,provice:provice,city:city,county:county,address:address,mobile:mobile,tel:tel,medium_range:medium_range},function(data){
			$(".gov_zhezhao").show();
			$(".set_sapp").show();
		});
	});
