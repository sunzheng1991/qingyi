...
REPLACE INTO `v9_admin` (`userid`, `username`, `password`, `roleid`, `encrypt`, `lastloginip`, `lastlogintime`, `email`, `realname`, `card`, `lang`) VALUES
	(1, 'sunzheng', 'ca3547e3dbc641a2bfe44538cf6ca819', 1, 'YHVrkf', '127.0.0.1', 1428825868, '452017791@qq.com', '', '', '');
...
-- 正在导出表  qingyi.v9_log 的数据：3 rows
...
-- 正在导出表  qingyi.v9_member 的数据：0 rows
...
CREATE TABLE IF NOT EXISTS `v9_school` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='学校表';

-- 正在导出表  qingyi.v9_school 的数据：31 rows
...
REPLACE INTO `v9_school` (`id`, `type`, `school_name`, `provice`, `city`, `county`, `address`, `head`, `mobile`, `tel`, `medium_range`, `class_fee`, `qr_code`, `school_logo`, `micro_site_url`, `status`, `apply_type`, `create_time`) VALUES
	...
	(32, 2, '北京大学123123', 11, 190, 1139, '123123', '孙正', '123123', '123132', '123123', 1000, '', '', '', 1, 0, 1429071540),
...
-- 正在导出表  qingyi.v9_sso_members 的数据：0 rows
...
-- 正在导出表  qingyi.v9_sso_messagequeue 的数据：0 rows
