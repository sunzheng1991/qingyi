...
CREATE TABLE IF NOT EXISTS `v9_school` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='学校表';

-- 正在导出表  qingyi.v9_school 的数据：22 rows
...
REPLACE INTO `v9_school` (`id`, `type`, `school_name`, `provice`, `city`, `county`, `address`, `head`, `mobile`, `tel`, `medium_range`, `class_fee`, `qr_code`, `school_logo`, `micro_site_url`, `status`, `apply_type`, `create_time`) VALUES
	(2, 0, '测试学校', 2, 41, 0, '', '孙正', '110', '110', '', 0, '', '', '', 1, 0, 1428907911),
...
-- 正在导出表  qingyi.v9_session 的数据：1 rows
/*!40000 ALTER TABLE `v9_session` DISABLE KEYS */;
REPLACE INTO `v9_session` (`sessionid`, `userid`, `ip`, `lastvisit`, `roleid`, `groupid`, `m`, `c`, `a`, `data`) VALUES
	('s2atb18ncvda1sqh6r971cgcp4', 1, '127.0.0.1', 1428877872, 1, 0, 'admin', 'index', 'public_session_life', 'code|s:5:"kgnwy";userid|s:1:"1";roleid|s:1:"1";pc_hash|s:6:"VxqAe6";lock_screen|i:0;');
