...
-- 导出 qingyi 的数据库结构
CREATE DATABASE IF NOT EXISTS `qingyi` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `qingyi`;


-- 导出  表 qingyi.v9_admin 结构
...
-- 正在导出表  qingyi.v9_admin 的数据：1 rows
/*!40000 ALTER TABLE `v9_admin` DISABLE KEYS */;
REPLACE INTO `v9_admin` (`userid`, `username`, `password`, `roleid`, `encrypt`, `lastloginip`, `lastlogintime`, `email`, `realname`, `card`, `lang`) VALUES
	(1, 'sunzheng', 'ca3547e3dbc641a2bfe44538cf6ca819', 1, 'YHVrkf', '', 1429184899, '452017791@qq.com', '', '', '');
/*!40000 ALTER TABLE `v9_admin` ENABLE KEYS */;


-- 导出  表 qingyi.v9_admin_panel 结构
...
-- 正在导出表  qingyi.v9_admin_role 的数据：6 rows
/*!40000 ALTER TABLE `v9_admin_role` DISABLE KEYS */;
REPLACE INTO `v9_admin_role` (`roleid`, `rolename`, `description`, `listorder`, `disabled`) VALUES
	(1, '超级管理员', '超级管理员', 0, 0),
	(2, '站点管理员', '站点管理员', 0, 0),
	(3, '运营总监', '运营总监', 1, 0),
	(4, '总编', '总编', 5, 0),
...
-- 导出  表 qingyi.v9_admin_role_priv 结构
...
-- 正在导出表  qingyi.v9_category 的数据：8 rows
/*!40000 ALTER TABLE `v9_category` DISABLE KEYS */;
REPLACE INTO `v9_category` (`catid`, `siteid`, `module`, `type`, `modelid`, `parentid`, `arrparentid`, `child`, `arrchildid`, `catname`, `style`, `image`, `description`, `parentdir`, `catdir`, `url`, `items`, `hits`, `setting`, `listorder`, `ismenu`, `sethtml`, `letter`, `usable_type`) VALUES
...
-- 导出  表 qingyi.v9_category_priv 结构
...
-- 正在导出表  qingyi.v9_comment_setting 的数据：1 rows
/*!40000 ALTER TABLE `v9_comment_setting` DISABLE KEYS */;
REPLACE INTO `v9_comment_setting` (`siteid`, `guest`, `check`, `code`, `add_point`, `del_point`) VALUES
	(1, 0, 0, 0, 0, 0);
/*!40000 ALTER TABLE `v9_comment_setting` ENABLE KEYS */;


-- 导出  表 qingyi.v9_comment_table 结构
...
-- 正在导出表  qingyi.v9_comment_table 的数据：1 rows
/*!40000 ALTER TABLE `v9_comment_table` DISABLE KEYS */;
REPLACE INTO `v9_comment_table` (`tableid`, `total`, `creat_at`) VALUES
	(1, 0, 0);
/*!40000 ALTER TABLE `v9_comment_table` ENABLE KEYS */;


-- 导出  表 qingyi.v9_content_check 结构
...
-- 正在导出表  qingyi.v9_downservers 的数据：0 rows
/*!40000 ALTER TABLE `v9_downservers` DISABLE KEYS */;
/*!40000 ALTER TABLE `v9_downservers` ENABLE KEYS */;


-- 导出  表 qingyi.v9_error 结构
CREATE TABLE IF NOT EXISTS `v9_error` (
  ...
  `manage` varchar(500) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='纠错表';

-- 正在导出表  qingyi.v9_error 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `v9_error` DISABLE KEYS */;
REPLACE INTO `v9_error` (`id`, `school_id`, `school_name`, `name`, `tel`, `desc`, `manage`, `status`) VALUES
	(1, 2, '测试学校', '123123', '123123', '1231231', '测试测试', 0);
/*!40000 ALTER TABLE `v9_error` ENABLE KEYS */;


-- 导出  表 qingyi.v9_extend_setting 结构
...
-- 正在导出表  qingyi.v9_link 的数据：2 rows
/*!40000 ALTER TABLE `v9_link` DISABLE KEYS */;
REPLACE INTO `v9_link` (`linkid`, `siteid`, `typeid`, `linktype`, `name`, `url`, `logo`, `introduce`, `username`, `listorder`, `elite`, `passed`, `addtime`) VALUES
	(1, 1, 0, 1, 'PHPCMS', 'http://www.phpcms.cn', 'http://www.phpcms.cn/images/logo_88_31.gif', '', '', 0, 0, 1, 1428825064),
	(2, 1, 0, 1, '盛大在线', 'http://www.sdo.com', 'http://www.snda.com/cn/logo/comp_logo_sdo.gif', '', '', 0, 0, 1, 1428825064);
/*!40000 ALTER TABLE `v9_link` ENABLE KEYS */;


-- 导出  表 qingyi.v9_linkage 结构
...
-- 正在导出表  qingyi.v9_linkage 的数据：3,284 rows
/*!40000 ALTER TABLE `v9_linkage` DISABLE KEYS */;
REPLACE INTO `v9_linkage` (`linkageid`, `name`, `style`, `parentid`, `child`, `arrchildid`, `keyid`, `listorder`, `description`, `setting`, `siteid`) VALUES
...
-- 正在导出表  qingyi.v9_log 的数据：17 rows
/*!40000 ALTER TABLE `v9_log` DISABLE KEYS */;
REPLACE INTO `v9_log` (`logid`, `field`, `value`, `module`, `file`, `action`, `querystring`, `data`, `userid`, `username`, `ip`, `time`) VALUES
	(1, '', 0, 'admin', '', 'index', '?m=admin&c=index&a=login', '', 0, '', '127.0.0.1', '2015-04-12 15:52:22'),
	(2, '', 0, 'admin', '', 'index', '?m=admin&c=index&a=login', '', 0, '', '127.0.0.1', '2015-04-12 16:04:15'),
	(3, '', 0, 'admin', '', 'index', '?m=admin&c=index&a=login', '', 0, '', '127.0.0.1', '2015-04-12 16:04:28'),
	(4, '', 0, 'admin', '', 'index', '?m=admin&c=index&a=login', '', 0, '', '', '2015-04-16 19:48:14'),
	(5, '', 0, 'admin', '', 'index', '?m=admin&c=index&a=login', '', 0, '', '', '2015-04-16 19:48:19'),
	(6, '', 0, 'content', '', 'content', '?m=content&c=content&a=add', '', 1, 'sunzheng', '', '2015-04-16 19:49:58'),
	(7, '', 0, 'content', '', 'content', '?m=content&c=content&a=add', '', 1, 'sunzheng', '', '2015-04-16 19:50:17'),
	(8, '', 0, 'content', '', 'content', '?m=content&c=content&a=add', '', 1, 'sunzheng', '', '2015-04-16 19:50:42'),
	(9, '', 0, 'content', '', 'content', '?m=content&c=content&a=add', '', 1, 'sunzheng', '', '2015-04-16 19:56:06'),
	(10, '', 0, 'member', '', 'member', '?m=member&c=member&a=manage', '', 1, 'sunzheng', '', '2015-04-16 19:57:07'),
	(11, '', 0, 'member', '', 'member', '?m=member&c=member&a=add', '', 1, 'sunzheng', '', '2015-04-16 19:57:09'),
	(12, '', 0, 'member', '', 'member', '?m=member&c=member&a=add', '', 1, 'sunzheng', '', '2015-04-16 19:57:18'),
	(13, '', 0, 'member', '', 'member', '?m=member&c=member&a=add', '', 1, 'sunzheng', '', '2015-04-16 19:57:32'),
	(14, '', 0, 'member', '', 'member', '?m=member&c=member&a=manage', '', 1, 'sunzheng', '', '2015-04-16 19:57:32'),
	(15, '', 0, 'member', '', 'member', '?m=member&c=member&a=memberinfo', '', 1, 'sunzheng', '', '2015-04-16 19:57:33'),
	(16, '', 0, 'member', '', 'member', '?m=member&c=member&a=edit', '', 1, 'sunzheng', '', '2015-04-16 19:57:36'),
	(17, '', 0, 'member', '', 'member', '?m=member&c=member&a=memberinfo', '', 1, 'sunzheng', '', '2015-04-16 19:57:40');
/*!40000 ALTER TABLE `v9_log` ENABLE KEYS */;


-- 导出  表 qingyi.v9_member 结构
...
-- 正在导出表  qingyi.v9_member 的数据：1 rows
/*!40000 ALTER TABLE `v9_member` DISABLE KEYS */;
REPLACE INTO `v9_member` (`userid`, `phpssouid`, `username`, `password`, `encrypt`, `nickname`, `regdate`, `lastdate`, `regip`, `lastip`, `loginnum`, `email`, `groupid`, `areaid`, `amount`, `point`, `modelid`, `message`, `islock`, `vip`, `overduedate`, `siteid`, `connectid`, `from`, `mobile`) VALUES
	(1, 1, '123123', 'aac65e2f0d4ffe0cb278f2bdb76d1c3f', 'QGtflf', '1231231', 1429185452, 1429185477, '', '', 0, '123123@qq.com', 2, 0, 0.00, 1, 10, 0, 0, 0, 0, 1, '', '', '');
/*!40000 ALTER TABLE `v9_member` ENABLE KEYS */;


-- 导出  表 qingyi.v9_member_detail 结构
...
-- 正在导出表  qingyi.v9_member_group 的数据：7 rows
/*!40000 ALTER TABLE `v9_member_group` DISABLE KEYS */;
REPLACE INTO `v9_member_group` (`groupid`, `name`, `issystem`, `starnum`, `point`, `allowmessage`, `allowvisit`, `allowpost`, `allowpostverify`, `allowsearch`, `allowupgrade`, `allowsendmessage`, `allowpostnum`, `allowattachment`, `price_y`, `price_m`, `price_d`, `icon`, `usernamecolor`, `description`, `sort`, `disabled`) VALUES
...
-- 正在导出表  qingyi.v9_member_menu 的数据：3 rows
/*!40000 ALTER TABLE `v9_member_menu` DISABLE KEYS */;
REPLACE INTO `v9_member_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `listorder`, `display`, `isurl`, `url`) VALUES
...
-- 导出  表 qingyi.v9_member_verify 结构
...
-- 正在导出表  qingyi.v9_menu 的数据：335 rows
/*!40000 ALTER TABLE `v9_menu` DISABLE KEYS */;
REPLACE INTO `v9_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES
...
-- 正在导出表  qingyi.v9_model 的数据：5 rows
/*!40000 ALTER TABLE `v9_model` DISABLE KEYS */;
REPLACE INTO `v9_model` (`modelid`, `siteid`, `name`, `description`, `tablename`, `setting`, `addtime`, `items`, `enablesearch`, `disabled`, `default_style`, `category_template`, `list_template`, `show_template`, `js_template`, `admin_list_template`, `member_add_template`, `member_list_template`, `sort`, `type`) VALUES
...
-- 正在导出表  qingyi.v9_model_field 的数据：101 rows
/*!40000 ALTER TABLE `v9_model_field` DISABLE KEYS */;
REPLACE INTO `v9_model_field` (`fieldid`, `modelid`, `siteid`, `field`, `name`, `tips`, `css`, `minlength`, `maxlength`, `pattern`, `errortips`, `formtype`, `setting`, `formattribute`, `unsetgroupids`, `unsetroleids`, `iscore`, `issystem`, `isunique`, `isbase`, `issearch`, `isadd`, `isfulltext`, `isposition`, `listorder`, `disabled`, `isomnipotent`) VALUES
...
-- 正在导出表  qingyi.v9_module 的数据：27 rows
/*!40000 ALTER TABLE `v9_module` DISABLE KEYS */;
REPLACE INTO `v9_module` (`module`, `name`, `url`, `iscore`, `version`, `description`, `setting`, `listorder`, `disabled`, `installdate`, `updatedate`) VALUES
	...
	('announce', '公告', 'announce/', 0, '1.0', '公告', '', 0, 0, '2015-04-12', '2015-04-12'),
	('comment', '评论', 'comment/', 0, '1.0', '评论', '', 0, 0, '2015-04-12', '2015-04-12'),
	('link', '友情链接', '', 0, '1.0', '', 'array (\n  1 => \n  array (\n    \'is_post\' => \'1\',\n    \'enablecheckcode\' => \'0\',\n  ),\n)', 0, 0, '2010-09-06', '2010-09-06'),
	('vote', '投票', '', 0, '1.0', '', 'array (\r\n  1 => \r\n  array (\r\n    \'default_style\' => \'default\',\r\n    \'vote_tp_template\' => \'vote_tp\',\r\n    \'allowguest\' => \'1\',\r\n    \'enabled\' => \'1\',\r\n    \'interval\' => \'1\',\r\n    \'credit\' => \'1\',\r\n  ),\r\n)', 0, 0, '2010-09-06', '2010-09-06'),
	('message', '短消息', '', 0, '1.0', '', '', 0, 0, '2010-09-06', '2010-09-06'),
	('mood', '新闻心情', 'mood/', 0, '1.0', '新闻心情', '', 0, 0, '2015-04-12', '2015-04-12'),
	('poster', '广告模块', 'poster/', 0, '1.0', '广告模块', '', 0, 0, '2015-04-12', '2015-04-12'),
	('formguide', '表单向导', 'formguide/', 0, '1.0', 'formguide', 'array (\n  \'allowmultisubmit\' => \'1\',\n  \'interval\' => \'30\',\n  \'allowunreg\' => \'0\',\n  \'mailmessage\' => \'用户向我们提交了表单数据，赶快去看看吧。\',\n)', 0, 0, '2010-10-20', '2010-10-20'),
	('wap', '手机门户', 'wap/', 0, '1.0', '手机门户', '', 0, 0, '2015-04-12', '2015-04-12'),
	('upgrade', '在线升级', '', 0, '1.0', '', '', 0, 0, '2011-05-18', '2011-05-18'),
	('tag', '标签向导', 'tag/', 0, '1.0', '标签向导', '', 0, 0, '2015-04-12', '2015-04-12'),
	('sms', '短信平台', 'sms/', 0, '1.0', '短信平台', '', 0, 0, '2011-09-02', '2011-09-02');
/*!40000 ALTER TABLE `v9_module` ENABLE KEYS */;


-- 导出  表 qingyi.v9_mood 结构
...
-- 正在导出表  qingyi.v9_position 的数据：12 rows
/*!40000 ALTER TABLE `v9_position` DISABLE KEYS */;
REPLACE INTO `v9_position` (`posid`, `modelid`, `catid`, `name`, `maxnum`, `extention`, `listorder`, `siteid`, `thumb`) VALUES
...
-- 导出  表 qingyi.v9_position_data 结构
...
-- 正在导出表  qingyi.v9_poster 的数据：10 rows
/*!40000 ALTER TABLE `v9_poster` DISABLE KEYS */;
REPLACE INTO `v9_poster` (`id`, `siteid`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`) VALUES
	(1, 1, 'banner', 1, 'images', 'array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://localhost/qingyi/uploadfile/poster/2.png\',\n    \'alt\' => \'\',\n  ),\n)', 1285813808, 1446249600, 1285813833, 0, 1, 0, 0),
	(2, 1, 'phpcmsv9', 2, 'images', 'array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://localhost/qingyi/statics/images/v9/ad_login.jpg\',\n    \'alt\' => \'phpcms专业建站系统\',\n  ),\n)', 1285816298, 1446249600, 1285816310, 0, 1, 0, 0),
	(3, 1, 'phpcms下载推荐', 3, 'images', 'array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://localhost/qingyi/uploadfile/poster/3.png\',\n    \'alt\' => \'phpcms官方\',\n  ),\n)', 1286504815, 1446249600, 1286504865, 0, 1, 0, 0),
	(4, 1, 'phpcms广告', 4, 'images', 'array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://localhost/qingyi/uploadfile/poster/4.gif\',\n    \'alt\' => \'phpcms官方\',\n  ),\n)', 1286505141, 1446249600, 1286505178, 0, 0, 0, 0),
	(5, 1, 'phpcms下载', 5, 'images', 'array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://localhost/qingyi/uploadfile/poster/5.gif\',\n    \'alt\' => \'官方\',\n  ),\n)', 1286509363, 1446249600, 1286509401, 0, 0, 0, 0),
...
-- 正在导出表  qingyi.v9_poster_201504 的数据：0 rows
/*!40000 ALTER TABLE `v9_poster_201504` DISABLE KEYS */;
/*!40000 ALTER TABLE `v9_poster_201504` ENABLE KEYS */;


-- 导出  表 qingyi.v9_poster_space 结构
...
-- 正在导出表  qingyi.v9_poster_space 的数据：10 rows
/*!40000 ALTER TABLE `v9_poster_space` DISABLE KEYS */;
REPLACE INTO `v9_poster_space` (`spaceid`, `siteid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`) VALUES
...
-- 正在导出表  qingyi.v9_release_point 的数据：0 rows
/*!40000 ALTER TABLE `v9_release_point` DISABLE KEYS */;
/*!40000 ALTER TABLE `v9_release_point` ENABLE KEYS */;


-- 导出  表 qingyi.v9_school 结构
CREATE TABLE IF NOT EXISTS `v9_school` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(11) NOT NULL DEFAULT '3' COMMENT '学校类型',
  `school_name` varchar(50) NOT NULL COMMENT '学校名称',
  `provice` int(11) NOT NULL DEFAULT '0' COMMENT '省',
  ...
  `tel` varchar(20) NOT NULL COMMENT '固话',
  `medium_range` varchar(100) NOT NULL COMMENT '授课范围',
  `class_fee` int(11) NOT NULL COMMENT '课时费用',
  `qr_code` varchar(250) NOT NULL COMMENT '二维码',
  `school_logo` varchar(250) NOT NULL COMMENT '学校logo',
  `micro_site_url` varchar(300) NOT NULL COMMENT '微站url',
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '申请状态0:未处理，1：已处理',
  `apply_type` int(11) NOT NULL DEFAULT '0' COMMENT '申请类型0：学校，1：微站',
  `create_time` int(11) NOT NULL COMMENT '加入时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='学校表';

-- 正在导出表  qingyi.v9_school 的数据：0 rows
/*!40000 ALTER TABLE `v9_school` DISABLE KEYS */;
REPLACE INTO `v9_school` (`id`, `type`, `school_name`, `provice`, `city`, `county`, `address`, `head`, `mobile`, `tel`, `medium_range`, `class_fee`, `qr_code`, `school_logo`, `micro_site_url`, `status`, `apply_type`, `create_time`) VALUES
	(1, 3, '北航点', 2, 42, 0, '知春路罗庄南里宏嘉丽园3号楼B座201', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429455308),
	(2, 3, '北京一书阁--清河点', 2, 42, 0, '清河嘉园东区甲一号1236室（翠微A座12层）', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456003),
	(3, 3, '北京一书阁--清上园点', 2, 42, 0, '清河镇清上园东路1号院清上园底商二层（二炮东200米路北）', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456024),
	(4, 3, '千寻美术学校北京总部', 2, 48, 0, '宋庄画家村小堡车区艺术中心3号', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456057),
	(5, 3, '北京彩翼儿童美术学校', 2, 40, 0, '朝阳路兴隆庄甲八号', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456075),
	(6, 3, '天墨书画培训中心', 3, 67, 0, '泗泾镇开江西路692号', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456102),
	(7, 3, '艺想天开童画虹口江湾校区', 3, 60, 0, '新市北路1523号2楼', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456121),
	(8, 3, '书法教育', 3, 57, 0, '安波路533弄硕和国际3号商务楼304室', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456145),
	(9, 3, '夏加儿童画', 3, 61, 0, '国顺东路800号东楼101室', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456171),
	(10, 3, '墨林书馆', 3, 57, 0, '康定路221-1号307室', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456191),
	(11, 3, '艺明画室', 4, 74, 0, '麦格理晓星园1-1-301室', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456211),
	(12, 3, '天津天天向上教育', 4, 72, 0, '南京路诚基中心2号楼1门2720室', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456236),
	(13, 3, '铭艺九洲画室', 4, 73, 0, '新开路南横街欣荣嘉园', '', '', '', '', 0, 'uploadfile/school/1429457516512.jpg', 'uploadfile/school/1429457490318.jpg', '', 1, 0, 1429456258),
	(14, 3, '天津艺铭教育', 4, 73, 0, '新开路南横街欣荣嘉园小区3-1-101', '', '', '', '', 0, 'uploadfile/school/1429457501611.jpg', 'uploadfile/school/1429457480144.jpg', '', 1, 0, 1429456276);
/*!40000 ALTER TABLE `v9_school` ENABLE KEYS */;


-- 导出  表 qingyi.v9_search 结构
...
-- 正在导出表  qingyi.v9_site 的数据：1 rows
/*!40000 ALTER TABLE `v9_site` DISABLE KEYS */;
REPLACE INTO `v9_site` (`siteid`, `name`, `dirname`, `domain`, `site_title`, `keywords`, `description`, `release_point`, `default_style`, `template`, `setting`, `uuid`) VALUES
	(1, '默认站点', '', 'http://localhost/qingyi/', 'PHPCMS演示站', 'PHPCMS演示站', 'PHPCMS演示站', '', 'default', 'default', 'array (\n  \'upload_maxsize\' => \'2048\',\n  \'upload_allowext\' => \'jpg|jpeg|gif|bmp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip|swf\',\n  \'watermark_enable\' => \'1\',\n  \'watermark_minwidth\' => \'300\',\n  \'watermark_minheight\' => \'300\',\n  \'watermark_img\' => \'/statics/images/water/mark.png\',\n  \'watermark_pct\' => \'85\',\n  \'watermark_quality\' => \'80\',\n  \'watermark_pos\' => \'9\',\n)', '828beacd-e0ea-11e4-b6e0-54271e0c9522');
/*!40000 ALTER TABLE `v9_site` ENABLE KEYS */;


-- 导出  表 qingyi.v9_sms_report 结构
...
-- 正在导出表  qingyi.v9_sso_admin 的数据：1 rows
/*!40000 ALTER TABLE `v9_sso_admin` DISABLE KEYS */;
REPLACE INTO `v9_sso_admin` (`id`, `username`, `password`, `encrypt`, `issuper`, `lastlogin`, `ip`) VALUES
	(1, 'sunzheng', '4077279878ef7ea24065e0c020da15e1', '5BaZm4', 1, 0, '');
/*!40000 ALTER TABLE `v9_sso_admin` ENABLE KEYS */;


-- 导出  表 qingyi.v9_sso_applications 结构
...
-- 正在导出表  qingyi.v9_sso_applications 的数据：1 rows
/*!40000 ALTER TABLE `v9_sso_applications` DISABLE KEYS */;
REPLACE INTO `v9_sso_applications` (`appid`, `type`, `name`, `url`, `authkey`, `ip`, `apifilename`, `charset`, `synlogin`) VALUES
	(1, 'phpcms_v9', 'phpcms v9', 'http://localhost/qingyi/', 'GthsXRA82DRZvtXDnGy9XKgm5ZXT4z9X', '', 'api.php?op=phpsso', 'utf-8', 1);
/*!40000 ALTER TABLE `v9_sso_applications` ENABLE KEYS */;


-- 导出  表 qingyi.v9_sso_members 结构
...
-- 正在导出表  qingyi.v9_sso_members 的数据：1 rows
/*!40000 ALTER TABLE `v9_sso_members` DISABLE KEYS */;
REPLACE INTO `v9_sso_members` (`uid`, `username`, `password`, `random`, `email`, `regip`, `regdate`, `lastip`, `lastdate`, `appname`, `type`, `avatar`, `ucuserid`) VALUES
	(1, '123123', 'aac65e2f0d4ffe0cb278f2bdb76d1c3f', 'QGtflf', '123123@qq.com', '', 1429185452, '', 1429185477, 'phpcms v9', 'app', 0, 0);
/*!40000 ALTER TABLE `v9_sso_members` ENABLE KEYS */;


-- 导出  表 qingyi.v9_sso_messagequeue 结构
...
-- 正在导出表  qingyi.v9_sso_messagequeue 的数据：1 rows
/*!40000 ALTER TABLE `v9_sso_messagequeue` DISABLE KEYS */;
REPLACE INTO `v9_sso_messagequeue` (`id`, `operation`, `succeed`, `totalnum`, `noticedata`, `dateline`, `appstatus`) VALUES
	(1, 'member_add', 0, 1, 'array (\n  \'username\' => \'123123\',\n  \'password\' => \'aac65e2f0d4ffe0cb278f2bdb76d1c3f\',\n  \'email\' => \'123123@qq.com\',\n  \'regip\' => \'\',\n  \'regdate\' => \'1429185452\',\n  \'lastdate\' => \'1429185452\',\n  \'appname\' => \'phpcms v9\',\n  \'type\' => \'app\',\n  \'random\' => \'QGtflf\',\n  \'ucuserid\' => \'0\',\n  \'uid\' => \'1\',\n  \'action\' => \'member_add\',\n)', 1429185452, '{"1":1}');
/*!40000 ALTER TABLE `v9_sso_messagequeue` ENABLE KEYS */;


-- 导出  表 qingyi.v9_sso_session 结构
...
-- 正在导出表  qingyi.v9_sso_settings 的数据：5 rows
/*!40000 ALTER TABLE `v9_sso_settings` DISABLE KEYS */;
REPLACE INTO `v9_sso_settings` (`name`, `data`) VALUES
	('denyemail', ''),
	('denyusername', ''),
	('creditrate', ''),
	('sp4', ''),
...
-- 导出  表 qingyi.v9_system 结构
CREATE TABLE IF NOT EXISTS `v9_system` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hot_words` varchar(400) NOT NULL COMMENT '热词',
  `recommend_school` varchar(400) NOT NULL COMMENT '推荐学校',
  `new_school` varchar(400) NOT NULL COMMENT '最新学校',
  `hot_city` varchar(400) NOT NULL COMMENT '热门城市',
  `images1` varchar(400) NOT NULL,
  `images2` varchar(400) NOT NULL,
  `images3` varchar(400) NOT NULL,
  `images4` varchar(400) NOT NULL,
  `images5` varchar(400) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='系统设置表';

-- 正在导出表  qingyi.v9_system 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `v9_system` DISABLE KEYS */;
REPLACE INTO `v9_system` (`id`, `hot_words`, `recommend_school`, `new_school`, `hot_city`, `images1`, `images2`, `images3`, `images4`, `images5`) VALUES
	(1, '书法;绘画', '13;14;10;11', '1;2;3;4', '北京市;上海市', 'uploadfile/school/1429343501542.jpg', 'uploadfile/school/1429343504242.jpg', 'uploadfile/school/1429343506570.jpg', 'uploadfile/school/1429343512493.jpg', 'uploadfile/school/1429454726138.jpg');
/*!40000 ALTER TABLE `v9_system` ENABLE KEYS */;


-- 导出  表 qingyi.v9_tag 结构
...
-- 正在导出表  qingyi.v9_type 的数据：4 rows
/*!40000 ALTER TABLE `v9_type` DISABLE KEYS */;
REPLACE INTO `v9_type` (`typeid`, `siteid`, `module`, `modelid`, `name`, `parentid`, `typedir`, `url`, `template`, `listorder`, `description`) VALUES
...
-- 正在导出表  qingyi.v9_urlrule 的数据：8 rows
/*!40000 ALTER TABLE `v9_urlrule` DISABLE KEYS */;
REPLACE INTO `v9_urlrule` (`urlruleid`, `module`, `file`, `ishtml`, `urlrule`, `example`) VALUES
...
-- 正在导出表  qingyi.v9_wap 的数据：1 rows
/*!40000 ALTER TABLE `v9_wap` DISABLE KEYS */;
REPLACE INTO `v9_wap` (`siteid`, `sitename`, `logo`, `domain`, `setting`, `status`) VALUES
	(1, 'PHPCMS手机门户', '/statics/images/wap/wlogo.gif', '', 'array (\n  \'listnum\' => \'10\',\n  \'thumb_w\' => \'220\',\n  \'thumb_h\' => \'0\',\n  \'c_num\' => \'1000\',\n  \'index_template\' => \'index\',\n  \'category_template\' => \'category\',\n  \'list_template\' => \'list\',\n  \'show_template\' => \'show\',\n)', 0);
/*!40000 ALTER TABLE `v9_wap` ENABLE KEYS */;


-- 导出  表 qingyi.v9_wap_type 结构
...
-- 正在导出表  qingyi.v9_workflow 的数据：4 rows
/*!40000 ALTER TABLE `v9_workflow` DISABLE KEYS */;
REPLACE INTO `v9_workflow` (`workflowid`, `siteid`, `steps`, `workname`, `description`, `setting`, `flag`) VALUES
	(1, 1, 1, '一级审核', '审核一次', '', 0),
	(2, 1, 2, '二级审核', '审核两次', '', 0),
	(3, 1, 3, '三级审核', '审核三次', '', 0),
	(4, 1, 4, '四级审核', '四级审核', '', 0);
